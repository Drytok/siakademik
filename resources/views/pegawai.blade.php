        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <a href="{{ url('/cetakpegawai') }}" target="_blank" class="btn btn-info btn-md">
                        Cetak Report
                    </a>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="modalcreate">New Create Pegawai</h4>
                                    ...
                                    <form action="/pegawai" method="POST">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="last-name" name="nama_pegawai" required="required"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <label for="middle-name"
                                                class="col-form-label col-md-3 col-sm-3 label-align">Jabatan
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            @foreach ($pegawai as $item)
                                ...
                                @include('modalpegawai.delete')
                                @include('modalpegawai.edit')
                            @endforeach
                        </tbody>
                    </table>
                </div>
