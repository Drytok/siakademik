    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalcreate">New Create Tahun Ajaran {{ $item->id }}</h4>
                ...
                <form action="/tahun_ajaran/{{ $item->id }}" method="POST">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="last-name" name="tahun_ajaran" value="{{ $item->tahun_ajaran }}"
                                required="required" class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Semester
                        </label>
                        <div class="col-md-6 col-sm-6 ">
