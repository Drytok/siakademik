                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="modalcreate">New Create Wali Murid</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                            aria-hidden="true">&times;</span></button>
                                </div>
                                <div class="modal-body">
                                    {{-- @dd($murid) --}}
                                    <form action="/wali_murid" method="POST">
                                        {{ csrf_field() }}
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="last-name" name="nama_wali" required="required"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class="headings">
                                <th class="column-title">Nama Wali </th>
                        ...
                        <tbody>
                            @foreach ($wali_murid as $item)
                                ...
                                @include('modalwalimurid.delete')
                                @include('modalwalimurid.edit')
                            @endforeach
                        </tbody>
                    </table>
                </div>
