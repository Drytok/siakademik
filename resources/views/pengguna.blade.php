                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="modalcreate">New Create Pengguna</h4>
                                    ...
                                    <form action="/pengguna" method="POST">
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                for="last-name">Username
                                                <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="last-name" name="username" required="required"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="middle-name"
                                                class="col-form-label col-md-3 col-sm-3 label-align">Email
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            @foreach ($pengguna as $item)
                                ...
                                @include('modalpengguna.delete')
                                @include('modalpengguna.edit')
                            @endforeach
                        </tbody>
                    </table>
                </div>
